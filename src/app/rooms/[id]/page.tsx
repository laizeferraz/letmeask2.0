          ...
          <div className="flex justify-between items-center mt-4">
            {user ? (
              ...
              <span className="font-medium text-gray-500 text-sm">
                To ask a question, <button className="bg-transparent border-0 text-blue-500 underline text-base cursor-pointer font-medium"
              ...
              >
                {!question.isAnswered && (
                  ...
                  >
                    ...
                    <svg className={`${question.likeId ? "stroke-blue-500" : "stroke-black-700"} h-[20px] w-[20px] -mt-2 lg:h-[24px] lg:w-[24px]`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
